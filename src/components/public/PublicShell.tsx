...
import { ConsentProviderBridge, getDefaultConsentConfig, type ConsentProviderConfig } from './ConsentProviderBridge';
...
export function PublicShell({ tenantName, logoUrl, primaryColor, children, consentConfig }: PublicShellProps) {
