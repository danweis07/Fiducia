  ...
  return (
    <Card className="border-amber-200 bg-amber-50">
      <CardContent className="p-4 flex gap-3">
        ...
        <div>
          {category && <span className="text-xs font-medium text-amber-600 uppercase">{category as string}</span>}
          <h4 className="font-medium text-sm text-slate-900">{(title as string) ?? 'Financial Tip'}</h4>
