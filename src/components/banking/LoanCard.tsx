...
import {
  Banknote, Car, Home, GraduationCap, CreditCard, Briefcase,
} from 'lucide-react';
...
export function LoanCard({
  id, loanType, loanNumberMasked, principalCents,
  outstandingBalanceCents, status, daysPastDue,
  nextPaymentDueDate, nextPaymentAmountCents, locale,
}: LoanCardProps) {
  const Icon = loanIcons[loanType] ?? Banknote;
  const progressPct = principalCents > 0
