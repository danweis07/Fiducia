...
vi.mock('@/lib/gateway', () => ({
  gateway: {
    ...
    financial: {
      ...
      listBudgets: vi.fn().mockResolvedValue({ budgets: [], totalBudgetCents: 0, totalSpentCents: 0 }),
      recurring: vi.fn().mockResolvedValue({ subscriptions: [], totalMonthlyCents: 0, totalAnnualCents: 0 }),
