...
const mockConfig = {
  ...
  credentials: {
    username: { minLength: 6, maxLength: 30, allowEmail: true, pattern: '^[a-zA-Z0-9._@]+$', patternDescription: 'Letters, numbers, dots, underscores' },
    password: { minLength: 8, maxLength: 64, requireUppercase: true, requireLowercase: true, requireDigit: true, requireSpecialChar: true, specialChars: '!@#$%^&*', disallowUsername: true, historyCount: 3 },
    passkey: { enabled: false, allowPasswordless: false, rpId: 'test.com', rpName: 'Test', authenticatorAttachment: 'all' as const, requireResidentKey: false, userVerification: 'preferred' as const, attestation: 'none' as const },
  },
  mfa: {
    required: true,
