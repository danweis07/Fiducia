      ...
      <CardContent className="space-y-6">
        ...
        <div>
          ...
          <p className="font-medium">
            ...
            <Badge variant="secondary">
              {selectedProduct ? t(LOAN_TYPE_LABEL_KEYS[selectedProduct.loanType] || selectedProduct.loanType) : "—"}
            </Badge>
          </p>
        </div>
        ...
        <div>
          ...
          <div className="grid grid-cols-2 gap-x-4 gap-y-1 text-sm">
            ...
            <span>{form.termMonths} {t("loanApplication.months")}</span>
            ...
            {selectedProduct && (
              <>
                ...
                <span>
                  {(selectedProduct.interestRateBps / 100).toFixed(2)}%{" "}
