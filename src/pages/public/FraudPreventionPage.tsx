...
const victimSteps = [
  {
    ...
    description: 'Call our fraud hotline at (800) 555-FRAU (3728), available 24/7. We will freeze your account, reverse unauthorized transactions where possible, and issue new cards.',
  },
  {
    step: '2',
    title: 'File a Police Report',
    description: 'File a report with your local police department. Keep a copy of the report number for your records — you may need it for disputes and insurance claims.',
  },
  {
    step: '3',
    title: 'Place a Fraud Alert on Credit Reports',
    description: 'Contact one of the three major credit bureaus to place a fraud alert. They are required to notify the other two. Consider a credit freeze for maximum protection.',
  },
  {
    step: '4',
    title: 'Monitor Your Accounts',
    description: 'Review all your financial accounts for suspicious activity. Sign up for transaction alerts and check your credit report regularly at annualcreditreport.com.',
  },
];

const securityTips = [
  { icon: Lock, title: 'Use Strong Passwords', description: 'Create unique passwords of 12+ characters with a mix of letters, numbers, and symbols. Never reuse passwords across accounts.' },
  { icon: Smartphone, title: 'Enable Multi-Factor Authentication', description: 'Add an extra layer of security by enabling MFA on your online banking and email accounts.' },
  { icon: Eye, title: 'Monitor Statements Regularly', description: 'Review your account statements and transaction history at least weekly. Report any unfamiliar transactions immediately.' },
  { icon: Wifi, title: 'Use Secure Wi-Fi', description: 'Avoid accessing your financial accounts on public Wi-Fi networks. Use a VPN or your mobile data connection instead.' },
];
    ...
    <PublicShell tenantName="Demo Credit Union">
      ...
      <section className="bg-gradient-to-br from-slate-900 via-blue-900 to-slate-900 text-white py-20 px-4">
        <div className="max-w-5xl mx-auto text-center">
          ...
          <p className="text-xl text-slate-300 max-w-2xl mx-auto">
            Your financial security is our top priority. Learn how to recognize, prevent, and
            report fraud to keep your accounts safe.
          </p>
        </div>
      </section>
      ...
      <section className="py-16 px-4 bg-white">
        <div className="max-w-5xl mx-auto">
          <h2 className="text-3xl font-bold text-slate-900 text-center mb-4">Common Scams to Watch For</h2>
          <p className="text-slate-600 text-center mb-12 max-w-2xl mx-auto">
            Scammers are constantly evolving their tactics. Familiarize yourself with these
            common schemes to stay one step ahead.
          </p>
      ...
      <section className="py-16 px-4 bg-slate-50">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-3xl font-bold text-slate-900 text-center mb-4">If You&apos;re a Victim</h2>
          ...
          <div className="space-y-6">
            {victimSteps.map((item) => (
              <div key={item.step} className="flex items-start gap-6 bg-white rounded-xl p-6 shadow-sm">
      ...
      <section className="py-16 px-4 bg-slate-50">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-3xl font-bold text-slate-900 text-center mb-12">Emergency Contacts</h2>
