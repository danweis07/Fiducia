...
import { CreditCard, Star, Percent, Shield, Gift, Fuel, UtensilsCrossed, CheckCircle } from 'lucide-react';
  ...
  return (
    <PublicShell tenantName="Demo Credit Union">
      ...
      <section className="bg-gradient-to-br from-slate-900 via-slate-800 to-blue-900 text-white py-20 px-4">
        <div className="max-w-5xl mx-auto text-center">
          ...
          <p className="text-xl text-slate-300 max-w-2xl mx-auto mb-8">
            From earning rewards on everyday purchases to saving with a low rate, find the card
            that fits the way you spend.
          </p>
            ...
            <Card className="border-2 border-blue-500 shadow-lg relative">
              ...
              <CardContent>
                ...
                <ul className="space-y-2 text-sm text-slate-700 mb-6">
                  <li className="flex items-center gap-2"><CheckCircle className="h-4 w-4 text-green-500" /> No annual fee</li>
                  <li className="flex items-center gap-2"><CheckCircle className="h-4 w-4 text-green-500" /> 0% intro APR for 12 months</li>
                  <li className="flex items-center gap-2"><CheckCircle className="h-4 w-4 text-green-500" /> 13.99% – 21.99% variable APR after</li>
                </ul>
            ...
            <Card className="border-2 border-slate-200 hover:border-blue-300 transition-colors">
              ...
              <CardContent>
                <div className="bg-green-50 border border-green-200 rounded-lg p-4 mb-6 text-center">
                  ...
                  <p className="text-sm text-green-600 font-medium">Unlimited cash back on every purchase</p>
                </div>
                <ul className="space-y-2 text-sm text-slate-700 mb-6">
                  <li className="flex items-center gap-2"><CheckCircle className="h-4 w-4 text-green-500" /> No annual fee</li>
                  <li className="flex items-center gap-2"><CheckCircle className="h-4 w-4 text-green-500" /> No category tracking needed</li>
                  <li className="flex items-center gap-2"><CheckCircle className="h-4 w-4 text-green-500" /> 0% intro APR for 15 months</li>
                  <li className="flex items-center gap-2"><CheckCircle className="h-4 w-4 text-green-500" /> 12.99% – 22.99% variable APR after</li>
                  <li className="flex items-center gap-2"><CheckCircle className="h-4 w-4 text-green-500" /> Cash back redeemable anytime</li>
                </ul>
                <Button asChild className="w-full bg-blue-600 hover:bg-blue-700">
                  <Link to="/open-account">Apply Now</Link>
                </Button>
            ...
            <Card className="border-2 border-slate-200 hover:border-blue-300 transition-colors">
              ...
              <CardContent>
                <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-6 text-center">
                  ...
                  <p className="text-sm text-blue-600 font-medium">Variable APR — one of the lowest around</p>
                </div>
                <ul className="space-y-2 text-sm text-slate-700 mb-6">
                  <li className="flex items-center gap-2"><CheckCircle className="h-4 w-4 text-green-500" /> No annual fee</li>
                  <li className="flex items-center gap-2"><CheckCircle className="h-4 w-4 text-green-500" /> Ideal for balance transfers</li>
                  <li className="flex items-center gap-2"><CheckCircle className="h-4 w-4 text-green-500" /> 0% balance transfer APR for 12 months</li>
                  <li className="flex items-center gap-2"><CheckCircle className="h-4 w-4 text-green-500" /> No balance transfer fee</li>
                  <li className="flex items-center gap-2"><CheckCircle className="h-4 w-4 text-green-500" /> 8.99% – 17.99% variable APR</li>
                </ul>
                <Button asChild className="w-full bg-blue-600 hover:bg-blue-700">
                  <Link to="/open-account">Apply Now</Link>
                </Button>
      ...
      <section className="py-16 px-4 bg-slate-50">
        <div className="max-w-5xl mx-auto">
          <h2 className="text-2xl font-bold text-slate-900 text-center mb-10">Every Demo CU Card Includes</h2>
          <div className="grid sm:grid-cols-2 md:grid-cols-4 gap-6">
            {[
              { icon: Shield, title: 'Zero Liability', desc: 'Fraud protection on unauthorized purchases' },
              { icon: Star, title: 'No Annual Fee', desc: 'Keep your card without yearly charges' },
              { icon: Percent, title: 'Competitive Rates', desc: 'Lower rates than most national banks' },
              { icon: CreditCard, title: 'Contactless Pay', desc: 'Tap to pay with EMV chip technology' },
            ].map((benefit) => (
      ...
      <section className="py-16 px-4 bg-blue-600 text-white">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <p className="text-blue-100 mb-8 text-lg">
            Apply online in minutes with an instant decision. Start earning rewards or saving on interest today.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
