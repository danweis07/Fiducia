...
import { Home, CheckCircle, ArrowRight, Shield, Calculator, Star, Users, FileText } from 'lucide-react';
    ...
    <PublicShell tenantName="Demo Credit Union">
      ...
      <section className="bg-gradient-to-br from-slate-900 via-slate-800 to-blue-900 text-white py-20 px-4">
        <div className="max-w-5xl mx-auto text-center">
          ...
          <p className="text-xl text-slate-300 max-w-2xl mx-auto mb-8">
            ...
            offers competitive rates, low closing costs, and personalized service every step of the way.
          </p>
      ...
      <section className="py-16 px-4 bg-white">
        <div className="max-w-5xl mx-auto">
          <h2 className="text-3xl font-bold text-slate-900 text-center mb-4">Today's Mortgage Rates</h2>
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-12">
            ...
            <Card className="border-2 border-slate-200 hover:border-blue-300 transition-colors text-center">
              ...
              <CardContent>
                ...
                <p className="text-sm text-slate-600">Predictable payments for the life of your loan. The most popular choice for homebuyers.</p>
              </CardContent>
            </Card>
            ...
            <Card className="border-2 border-blue-500 shadow-lg text-center relative">
              ...
              <CardHeader className="pt-8">
                ...
                <Badge className="w-fit mx-auto bg-green-100 text-green-700">Save on Interest</Badge>
              </CardHeader>
              <CardContent>
                ...
                <p className="text-sm text-slate-500 mb-4">APR</p>
                <p className="text-sm text-slate-600">Build equity faster and pay significantly less interest over the life of the loan.</p>
              </CardContent>
            </Card>
            ...
            <Card className="border-2 border-slate-200 hover:border-blue-300 transition-colors text-center">
              <CardHeader>
                ...
                <Badge className="w-fit mx-auto bg-slate-100 text-slate-700">Lowest Start Rate</Badge>
              </CardHeader>
              <CardContent>
                ...
                <p className="text-sm text-slate-500 mb-4">APR</p>
                <p className="text-sm text-slate-600">Fixed rate for the first 5 years, then adjusts annually. Great if you plan to move or refinance.</p>
              </CardContent>
            </Card>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {[
              { title: 'FHA Loans', desc: 'Low down payment (3.5%), flexible credit requirements. Ideal for first-time buyers.', icon: Home },
              { title: 'VA Loans', desc: 'Zero down payment for eligible veterans and active military. No PMI required.', icon: Shield },
              { title: 'Jumbo Loans', desc: 'For loan amounts exceeding conforming limits. Competitive rates on luxury properties.', icon: FileText },
            ].map((loan) => (
        ...
        <div className="max-w-5xl mx-auto">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div className="bg-white rounded-xl shadow-lg p-8">
              <h3 className="text-xl font-bold text-slate-900 mb-6 text-center">Why Demo CU for Your Mortgage?</h3>
              <div className="space-y-6">
                {[
                  { icon: Star, title: 'Competitive Rates', desc: 'Credit union rates are typically lower than big banks' },
                  { icon: Users, title: 'Local Decisions', desc: 'Loans are approved and serviced right here — not sold off' },
                  { icon: Calculator, title: 'Low Fees', desc: 'Minimal closing costs and no hidden origination charges' },
                  { icon: Shield, title: 'Member Focused', desc: 'We succeed when you succeed — not the other way around' },
                ].map((item) => (
      ...
      <section className="py-16 px-4 bg-blue-600 text-white">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <p className="text-blue-100 mb-8 text-lg">
            Get pre-approved online in minutes. Know exactly how much home you can afford before you start shopping.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
          ...
          <p className="text-blue-200 text-xs mt-6">
            Rates effective as of March 14, 2026 and are subject to change without notice.
            APR = Annual Percentage Rate. All loans subject to credit approval.
          </p>
        </div>
      </section>
    </PublicShell>
