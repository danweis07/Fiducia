...
import { DollarSign, Home, Car, CreditCard, CheckCircle, ArrowRight, Calculator } from 'lucide-react';
    ...
    <PublicShell tenantName="Demo Credit Union">
      ...
      <section className="bg-gradient-to-br from-slate-900 via-slate-800 to-blue-900 text-white py-20 px-4">
        <div className="max-w-5xl mx-auto text-center">
          <Badge className="bg-blue-600 text-white mb-4 text-sm px-4 py-1">Rates as low as 5.24% APR</Badge>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <Card className="border-2 border-slate-200 hover:border-blue-300 transition-colors">
              ...
              <CardContent>
                ...
                <ul className="space-y-2 text-sm text-slate-700 mb-6">
                  <li className="flex items-center gap-2"><CheckCircle className="h-4 w-4 text-green-500" /> Fixed rates — payment never changes</li>
                  <li className="flex items-center gap-2"><CheckCircle className="h-4 w-4 text-green-500" /> No origination or application fee</li>
                  <li className="flex items-center gap-2"><CheckCircle className="h-4 w-4 text-green-500" /> Funds available in 1–2 business days</li>
                </ul>
            ...
            <Card className="border-2 border-slate-200 hover:border-blue-300 transition-colors">
              ...
              <CardContent>
                ...
                <ul className="space-y-2 text-sm text-slate-700 mb-6">
                  <li className="flex items-center gap-2"><CheckCircle className="h-4 w-4 text-green-500" /> Fixed and variable rate options</li>
                  <li className="flex items-center gap-2"><CheckCircle className="h-4 w-4 text-green-500" /> Interest may be tax deductible*</li>
                  <li className="flex items-center gap-2"><CheckCircle className="h-4 w-4 text-green-500" /> No annual fee on HELOC</li>
                </ul>
                <Button asChild className="w-full bg-blue-600 hover:bg-blue-700">
                  <Link to="/apply-loan">Apply Now</Link>
                </Button>
            ...
            <Card className="border-2 border-blue-500 shadow-lg relative">
              ...
              <CardContent>
                ...
                <ul className="space-y-2 text-sm text-slate-700 mb-6">
                  <li className="flex items-center gap-2"><CheckCircle className="h-4 w-4 text-green-500" /> Quick pre-approval decisions</li>
                  <li className="flex items-center gap-2"><CheckCircle className="h-4 w-4 text-green-500" /> Dealership or private party</li>
                  <li className="flex items-center gap-2"><CheckCircle className="h-4 w-4 text-green-500" /> No prepayment penalties</li>
                </ul>
                <Button asChild className="w-full bg-blue-600 hover:bg-blue-700">
                  <Link to="/apply-loan">Apply Now</Link>
                </Button>
            ...
            <Card className="border-2 border-slate-200 hover:border-blue-300 transition-colors">
              ...
              <CardContent>
                ...
                <ul className="space-y-2 text-sm text-slate-700 mb-6">
                  <li className="flex items-center gap-2"><CheckCircle className="h-4 w-4 text-green-500" /> Combine multiple payments into one</li>
                  <li className="flex items-center gap-2"><CheckCircle className="h-4 w-4 text-green-500" /> Lower your overall interest rate</li>
                  <li className="flex items-center gap-2"><CheckCircle className="h-4 w-4 text-green-500" /> Free financial counseling included</li>
                </ul>
                <Button asChild className="w-full bg-blue-600 hover:bg-blue-700">
                  <Link to="/apply-loan">Apply Now</Link>
                </Button>
      ...
      <section className="py-16 px-4 bg-blue-600 text-white">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <p className="text-blue-100 mb-8 text-lg">
            Apply online in minutes. Our lending team is here to help you find the right loan for your needs.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
          ...
          <p className="text-blue-200 text-xs mt-6">
            *Consult a tax advisor regarding the deductibility of interest. All rates are subject to credit approval
            and may vary based on creditworthiness, loan amount, and term. APR = Annual Percentage Rate.
          </p>
        </div>
      </section>
    </PublicShell>
