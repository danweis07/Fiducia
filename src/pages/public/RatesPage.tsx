...
const savingsRates = [
  { product: 'Regular Savings', apy: '0.45%', minBalance: '$5', details: 'No monthly maintenance fee' },
  { product: 'High-Yield Savings', apy: '4.25%', minBalance: '$500', details: '$500 minimum opening deposit' },
  { product: 'Money Market', apy: '4.50%', minBalance: '$2,500+', details: 'Tiered rates; higher balances earn more' },
];
...
const creditCardRates = [
  { product: 'Rewards Card', apr: '14.99% - 24.99% variable', details: 'Earn 1.5x points on every purchase' },
  { product: 'Cash Back Card', apr: '13.99% - 23.99% variable', details: '2% cash back on all purchases' },
  { product: 'Low Rate Card', apr: '8.99% - 18.99% variable', details: 'Our lowest rate credit card' },
];
      ...
      <section className="bg-gradient-to-br from-slate-900 via-blue-900 to-slate-900 text-white py-20 px-4">
        <div className="max-w-5xl mx-auto text-center">
          ...
          <p className="text-slate-300 max-w-2xl mx-auto mt-4">
            As a not-for-profit credit union, we return our earnings to members through
            better rates on savings and lower rates on loans.
          </p>
        </div>
      </section>
      ...
      <section className="py-12 px-4 bg-slate-100">
        <div className="max-w-5xl mx-auto">
          <div className="text-xs text-slate-500 space-y-2">
            <p>
              <strong>APY</strong> = Annual Percentage Yield. APYs are accurate as of March 14, 2026 and are
              subject to change without notice. Fees may reduce earnings. A penalty may be imposed for
              early withdrawal on certificates/CDs.
            </p>
            <p>
              <strong>APR</strong> = Annual Percentage Rate. Loan rates are based on creditworthiness, loan
              amount, term, and collateral. All loans are subject to credit approval. Rates and terms
              are subject to change without notice. Membership eligibility required.
            </p>
            <p>
              Mortgage rates assume a loan amount of $300,000 with 20% down payment and excellent credit.
              Actual rates may vary. APR reflects the cost of credit as a yearly rate including points
              and closing costs. Contact us for a personalized rate quote.
            </p>
            <p>
