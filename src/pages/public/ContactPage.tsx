...
const contactMethods = [
  ...
  },
  {
    ...
    details: ['Secure messaging available in online banking', 'Typical response within 1 business day'],
  },
  {
    icon: MapPin,
    title: 'Mail',
  ...
  return (
    <PublicShell tenantName="Demo Credit Union">
      ...
      <section className="bg-gradient-to-br from-slate-900 via-blue-900 to-slate-900 text-white py-20 px-4">
        <div className="max-w-5xl mx-auto text-center">
          ...
          <p className="text-xl text-slate-300 max-w-2xl mx-auto">
            We&apos;re here to help. Reach out by phone, email, mail, or visit any of our
            branch locations.
          </p>
        </div>
      </section>
      ...
      <section className="py-16 px-4 bg-slate-50">
        <div className="max-w-5xl mx-auto">
          <h2 className="text-3xl font-bold text-slate-900 text-center mb-12">Emergency &amp; Urgent</h2>
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <Card className="border-2 border-amber-200 bg-amber-50">
              ...
              <CardContent>
                ...
                <p className="text-sm text-amber-600 mt-2">
                  Report a lost or stolen debit or credit card immediately. We&apos;ll freeze
                  your card and issue a replacement right away.
                </p>
              </CardContent>
            </Card>
          </div>
