...
import { CheckCircle, CreditCard, Shield, Landmark, Wallet, GraduationCap, Star } from 'lucide-react';
    ...
    <PublicShell tenantName="Demo Credit Union">
      ...
      <section className="bg-gradient-to-br from-slate-900 via-slate-800 to-blue-900 text-white py-20 px-4">
        <div className="max-w-5xl mx-auto text-center">
          <Badge className="bg-blue-600 text-white mb-4 text-sm px-4 py-1">{t('checking.badge')}</Badge>
      ...
      <section className="py-16 px-4 bg-white">
        <div className="max-w-5xl mx-auto">
          <h2 className="text-3xl font-bold text-slate-900 text-center mb-12">{t('checking.whyTitle')}</h2>
          <div className="grid md:grid-cols-4 gap-8">
            {[
              { icon: Wallet, titleKey: 'checking.noMonthlyFees', descKey: 'checking.noMonthlyFeesDesc' },
              { icon: Landmark, titleKey: 'checking.noMinBalance', descKey: 'checking.noMinBalanceDesc' },
              { icon: CreditCard, titleKey: 'checking.freeDebitCard', descKey: 'checking.freeDebitCardDesc' },
              ...
              <div key={item.titleKey} className="text-center">
                ...
                <h3 className="font-semibold text-slate-900 mb-2">{t(item.titleKey, { atmCount })}</h3>
                <p className="text-sm text-slate-600">{t(item.descKey, { atmCount, atmNetworks })}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <section id="compare" className="py-16 px-4 bg-slate-50">
        <div className="max-w-5xl mx-auto">
          <h2 className="text-3xl font-bold text-slate-900 text-center mb-4">{t('checking.compareTitle')}</h2>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <Card className="border-2 border-slate-200 hover:border-blue-300 transition-colors">
              <CardHeader className="text-center pb-2">
                <Badge className="w-fit mx-auto bg-green-100 text-green-800 mb-2">{t('checking.mostPopular')}</Badge>
                <CardTitle className="text-2xl text-slate-900">{t('checking.basicChecking')}</CardTitle>
            ...
            <Card className="border-2 border-blue-500 shadow-lg relative">
              ...
              <CardHeader className="text-center pb-2 pt-8">
                <CardTitle className="text-2xl text-slate-900">{t('checking.premiumChecking')}</CardTitle>
                <p className="text-4xl font-bold text-blue-600 mt-2">$0</p>
                <p className="text-sm text-slate-500">{t('checking.withMinBalance', { amount: '$1,500' })}</p>
              </CardHeader>
              <CardContent>
                <ul className="space-y-3">
                  {[
            ...
            <Card className="border-2 border-slate-200 hover:border-blue-300 transition-colors">
              <CardHeader className="text-center pb-2">
                ...
                <CardTitle className="text-2xl text-slate-900">{t('checking.studentChecking')}</CardTitle>
                <p className="text-4xl font-bold text-blue-600 mt-2">{t('checking.free')}</p>
