...
describe('getDemoResponse', () => {
  ...
  it('returns single account', () => {
    const result = getDemoResponse('accounts.get', { id: 'acct-demo-checking-001' }) as Record<string, unknown>;
  ...
  it('returns transaction search results', () => {
    const result = getDemoResponse('transactions.search', { query: 'coffee' }) as Record<string, unknown>;
  ...
  it('creates a beneficiary', () => {
    const result = getDemoResponse('beneficiaries.create', { name: 'Test' }) as Record<string, unknown>;
    expect(result).toBeDefined();
  });
  ...
  it('sets card limit', () => {
    const result = getDemoResponse('cards.setLimit', { id: 'card-1', limitCents: 50000 }) as Record<string, unknown>;
    expect(result).toBeDefined();
  });

  // RDC
  it('submits an RDC deposit', () => {
    const result = getDemoResponse('rdc.deposit', { amountCents: 10000 }) as Record<string, unknown>;
    expect(result).toBeDefined();
  });
  ...
  it('returns experiment assignment', () => {
    const result = getDemoResponse('experiments.assign', { experimentId: 'exp-1' }) as Record<string, unknown>;
    expect(result).toBeDefined();
  });

  // Bill pay
  it('returns billers search', () => {
    const result = getDemoResponse('billpay.billers.search', { query: 'electric' }) as Record<string, unknown>;
    expect(result).toBeDefined();
  });
  ...
  it('returns joint owners', () => {
    const result = getDemoResponse('jointAccounts.owners.list', { accountId: 'acct-1' }) as Record<string, unknown>;
    expect(result).toBeDefined();
  });
  ...
  it('returns enrichment result', () => {
    const result = getDemoResponse('enrichment.enhance', { transactionId: 'txn-1' }) as Record<string, unknown>;
    expect(result).toBeDefined();
  });
  ...
  it('handles admin user actions', () => {
    const result = getDemoResponse('admin.users.suspend', { userId: 'u-1' }) as Record<string, unknown>;
    expect(result).toBeDefined();
  });
  ...
  it('returns KYC evaluation', () => {
    const result = getDemoResponse('kyc.evaluate', { firstName: 'John', lastName: 'Doe' }) as Record<string, unknown>;
    expect(result).toBeDefined();
  });
  ...
  it('returns activation verifyIdentity', () => {
    const result = getDemoResponse('activation.verifyIdentity', { memberNumber: '12345' }) as Record<string, unknown>;
    expect(result).toBeDefined();
  });
  ...
  it('gets account opening application', () => {
    const result = getDemoResponse('account-opening.get', { applicationId: 'app-1' }) as Record<string, unknown>;
    expect(result).toBeDefined();
  });
  ...
  it('tracks experiment event', () => {
    const result = getDemoResponse('experiments.track', { experimentId: 'exp-1' }) as Record<string, unknown>;
    expect(result).toBeDefined();
  });

  // Bill pay extended
  it('enrolls payee', () => {
    const result = getDemoResponse('billpay.payees.enroll', { billerId: 'b1' }) as Record<string, unknown>;
    expect(result).toBeDefined();
  });
  ...
  it('returns financial enrich', () => {
    const result = getDemoResponse('financial.enrich', { transactions: [] }) as Record<string, unknown>;
    expect(result).toBeDefined();
  });
  ...
  it('deactivates an offer', () => {
    const result = getDemoResponse('offers.deactivate', { offerId: 'o1' }) as Record<string, unknown>;
    expect(result).toBeDefined();
  });
  ...
  it('returns AI assistant chat', () => {
    const result = getDemoResponse('ai.assistant.chat', { message: 'Help' }) as Record<string, unknown>;
    expect(result).toBeDefined();
  });
  ...
  it('updates notification preferences', () => {
    const result = getDemoResponse('notifications.preferences.update', {}) as Record<string, unknown>;
    expect(result).toBeDefined();
  });
  ...
  it('revokes a session', () => {
    const result = getDemoResponse('sessions.revoke', { sessionId: 's-1' }) as Record<string, unknown>;
    expect(result).toBeDefined();
  });
  ...
  // RBAC extended
  it('creates a role', () => {
    const result = getDemoResponse('admin.roles.create', { name: 'Teller' }) as Record<string, unknown>;
    expect(result).toBeDefined();
  });
  ...
  it('returns integration health', () => {
    const result = getDemoResponse('integrations.health', { integrationId: 'i-1' }) as Record<string, unknown>;
    expect(result).toBeDefined();
  });
  ...
  it('returns admin analytics transaction volume', () => {
    const result = getDemoResponse('admin.analytics.transactionVolume', {}) as Record<string, unknown>;
    expect(result).toBeDefined();
  });
  ...
  it('returns enrichment batch', () => {
    const result = getDemoResponse('enrichment.batch', { transactions: [] }) as Record<string, unknown>;
    expect(result).toBeDefined();
  });
  ...
  it('returns CMS content versions', () => {
    const result = getDemoResponse('cms.content.versions', { contentId: 'c-1' }) as Record<string, unknown>;
    expect(result).toBeDefined();
  });

  it('returns public CMS content', () => {
    const result = getDemoResponse('cms.content.public', { slug: 'about' }) as Record<string, unknown>;
    expect(result).toBeDefined();
  });
