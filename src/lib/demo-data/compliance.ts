...
export const complianceHandlers: Record<string, ActionHandler> = {
  ...
  'activation.createTermsVersion': () => ({
    document: { id: 'terms-demo-001', type: 'terms_of_service', title: 'Terms of Service', content: 'Demo terms content.', version: '1.0', mandatory: true, isActive: true, createdAt: new Date().toISOString() },
  }),
