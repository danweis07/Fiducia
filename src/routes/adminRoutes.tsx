...
export function adminRoutes() {
  return (
    <Route path="/admin" element={<AdminProtectedRoute><ErrorBoundary><AdminShell /></ErrorBoundary></AdminProtectedRoute>}>
      ...
      <Route path="accounts" element={<ErrorBoundary><AccountOverview /></ErrorBoundary>} />
      <Route path="integrations" element={<ErrorBoundary><IntegrationManager /></ErrorBoundary>} />
      <Route path="branding" element={<ErrorBoundary><BrandingEditor /></ErrorBoundary>} />
      <Route path="compliance" element={<ErrorBoundary><ComplianceCenter /></ErrorBoundary>} />
      ...
      <Route path="settings" element={<ErrorBoundary><TenantSettings /></ErrorBoundary>} />
      <Route path="content" element={<ErrorBoundary><ContentManager /></ErrorBoundary>} />
      <Route path="api-tokens" element={<ErrorBoundary><ApiTokens /></ErrorBoundary>} />
      <Route path="experiments" element={<ErrorBoundary><Experiments /></ErrorBoundary>} />
      <Route path="sso" element={<ErrorBoundary><SSOConfiguration /></ErrorBoundary>} />
      ...
      <Route path="data-export" element={<ErrorBoundary><DataExport /></ErrorBoundary>} />
      <Route path="onboarding" element={<ErrorBoundary><TenantOnboarding /></ErrorBoundary>} />
      <Route path="agent-policies" element={<ErrorBoundary><AgentPolicies /></ErrorBoundary>} />
      <Route path="screen-manifests" element={<ErrorBoundary><ScreenManifests /></ErrorBoundary>} />
      <Route path="cdp" element={<ErrorBoundary><CDPManager /></ErrorBoundary>} />
      <Route path="incidents" element={<ErrorBoundary><IncidentManager /></ErrorBoundary>} />
      <Route path="control-tower" element={<ErrorBoundary><ControlTower /></ErrorBoundary>} />
      <Route path="changes" element={<ErrorBoundary><ChangeTracker /></ErrorBoundary>} />
    </Route>
  );
}
