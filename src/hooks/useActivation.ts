...
export function useVerifyIdentity() {
  return useMutation({
    mutationFn: (params: IdentityVerificationRequest) =>
      gateway.activation.verifyIdentity(params),
  });
}
...
export function useCreateCredentials() {
  return useMutation({
    mutationFn: (params: CredentialCreateRequest) =>
      gateway.activation.createCredentials(params),
  });
}
...
export function useEnrollMFA() {
  return useMutation({
    mutationFn: (params: MFAEnrollRequest) =>
      gateway.activation.enrollMFA(params),
  });
}
...
export function useVerifyMFA() {
  return useMutation({
    mutationFn: (params: MFAVerifyRequest) =>
      gateway.activation.verifyMFA(params),
  });
}
...
export function usePasskeyOptions() {
  return useMutation({
    mutationFn: (activationToken: string) =>
      gateway.activation.passkeyOptions(activationToken),
  });
}
...
export function useRegisterPasskey() {
  return useMutation({
    mutationFn: (params: PasskeyRegistrationResponse) =>
      gateway.activation.registerPasskey(params),
  });
}
...
export function useRegisterDevice() {
  return useMutation({
    mutationFn: (params: DeviceRegisterRequest) =>
      gateway.activation.registerDevice(params),
  });
}
...
export function useCompleteActivation() {
  ...
  return useMutation({
    mutationFn: (activationToken: string) =>
      gateway.activation.complete(activationToken),
    onSuccess: () => {
...
export function useTermsAcceptances(documentId?: string) {
  return useQuery({
    ...
    queryFn: () => gateway.activation.getTermsAcceptances({
      documentId,
      currentOnly: true,
    }),
  });
