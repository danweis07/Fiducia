...
export function useSCAExemptionCheck(params: Parameters<typeof gateway.sca.checkExemption>[0] | null) {
  return useQuery({
...
export function useInstantPayments(params: { accountId?: string; direction?: string; status?: string; limit?: number } = {}) {
  return useQuery({
