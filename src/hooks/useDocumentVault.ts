...
export function useVaultDocuments(params: { limit?: number; offset?: number; category?: VaultDocumentCategory } = {}) {
  return useQuery({
...
export function useSearchVaultDocuments(params: { query?: string; category?: VaultDocumentCategory; tags?: string[] }) {
  return useQuery({
