...
export type InternationalPaymentStatus = 'pending' | 'processing' | 'requires_action' | 'completed' | 'failed' | 'cancelled' | 'refunded';
export type PaymentRail = 'swift' | 'sepa' | 'sepa_instant' | 'faster_payments' | 'ach' | 'wire' | 'local_rails' | 'card';
...
export type InternationalLoanStatus = 'draft' | 'submitted' | 'in_review' | 'approved' | 'conditionally_approved' | 'denied' | 'withdrawn' | 'funded';
...
export type InternationalConsentStatus = 'active' | 'revoked' | 'expired' | 'suspended' | 'awaiting_reauthorization';
...
export type ConsentRegulation = 'psd2' | 'psd3' | 'open_banking_uk' | 'open_finance_brazil' | 'cfpb_1033' | 'cdp_australia';
...
export type SCAMethod = 'biometric_face' | 'biometric_fingerprint' | 'device_binding' | 'pin' | 'password' | 'totp';
...
export type EKYCVerificationStatus = 'pending' | 'in_progress' | 'verified' | 'failed' | 'expired' | 'manual_review';
