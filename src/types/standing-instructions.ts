...
export type StandingInstructionTransferType = 'account_to_account' | 'account_to_beneficiary' | 'loan_payment';
export type StandingInstructionFrequency = 'weekly' | 'biweekly' | 'monthly' | 'quarterly' | 'annually';
