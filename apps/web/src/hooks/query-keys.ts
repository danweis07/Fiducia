...
export const regulatoryKeys = {
  ...
  carbonTransaction: (transactionId: string) =>
    ["regulatory", "carbon", "transaction", transactionId] as const,
  carbonSummary: (periodStart: string, periodEnd: string) =>
    ["regulatory", "carbon", "summary", periodStart, periodEnd] as const,
};
...
export const overdraftKeys = {
  ...
  history: (accountId: string, limit?: number, offset?: number) =>
    ["overdraft", "history", accountId, limit, offset] as const,
...
export const spendingAlertKeys = {
  ...
  history: (limit?: number, offset?: number) =>
    ["spending-alerts", "history", limit, offset] as const,
...
export const internationalPaymentKeys = {
  ...
  fxQuote: (from: string, to: string, amount?: number) =>
    ["internationalPayments", "fxQuote", from, to, amount] as const,
  ...
  payouts: (params?: Record<string, unknown>) =>
    ["internationalPayments", "payouts", params] as const,
};

export const internationalBillPayKeys = {
  all: ["internationalBillPay"] as const,
  billers: (query: string, country?: string) =>
    ["internationalBillPay", "billers", query, country] as const,
  payments: (params?: Record<string, unknown>) =>
    ["internationalBillPay", "payments", params] as const,
...
export const internationalLoanKeys = {
  ...
  applications: (params?: Record<string, unknown>) =>
    ["internationalLoans", "applications", params] as const,
};
...
export const cashFlowKeys = {
  ...
  forecast: (accountId?: string, daysAhead?: number) =>
    ["cashflow", "forecast", accountId, daysAhead] as const,
};
...
export const currencyPotKeys = {
  ...
  swapQuote: (fromPotId: string, toPotId: string, amount: number) =>
    ["currencyPots", "swapQuote", fromPotId, toPotId, amount] as const,
...
export const complianceKeys = {
  ...
  interestWithholding: (accountId: string, taxYear?: string) =>
    ["compliance", "interestWithholding", accountId, taxYear] as const,
};
