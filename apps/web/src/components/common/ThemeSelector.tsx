    ...
    <Card>
      ...
      <CardContent className="space-y-6">
        ...
        <div className="space-y-2">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-5 gap-2">
            {Object.keys(THEME_PRESETS).map((key) => {
              ...
              const isActive =
                preset.primaryColor === theme.primaryColor && preset.layout === theme.layout;
              return (
                <button
                  key={key}
                  type="button"
        ...
        <div className="space-y-2">
          ...
          <Select value={theme.font} onValueChange={(v) => updateTheme({ font: v as ThemeFont })}>
        ...
        <div className="space-y-4">
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-sm text-muted-foreground">{t("settings.reducedMotionDesc")}</p>
            </div>
            <Switch
        ...
        <Button variant="outline" onClick={resetTheme} className="min-h-[44px]">
