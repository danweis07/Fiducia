...
export const accountHandlers: Record<string, ActionHandler> = {
  ...
  "transactions.get": (p) => ({
    transaction: TRANSACTIONS.find((t) => t.id === p.id) || TRANSACTIONS[0],
  }),
