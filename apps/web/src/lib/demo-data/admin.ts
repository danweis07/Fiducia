...
const ADMIN_ACCOUNTS = [
  ...
  },
  {
    ...
    balanceCents: 875000,
    status: "active" as const,
    openedAt: "2023-03-10T00:00:00Z",
    accountNumberMasked: "****2341",
  },
  {
    id: "acct-alice-002",
    customerName: "Alice Johnson",
    type: "savings" as const,
    balanceCents: 2100000,
    status: "active" as const,
    openedAt: "2023-04-01T00:00:00Z",
...
const ADMIN_AUDIT = [
  ...
  },
  {
    ...
    timestamp: isoDate(0),
    user: "demo@example.com",
    action: "transfer.create" as const,
    entityType: "transfer",
    entityId: "xfer-001",
    ipAddress: "192.168.1.100",
    details: "Internal transfer $500.00 Checking → Savings",
  },
  {
    id: "audit-003",
    timestamp: isoDate(1),
  ...
  },
  {
    ...
    timestamp: isoDate(2),
    user: "demo@example.com",
    action: "bill.pay" as const,
    entityType: "bill",
    entityId: "bill-003",
    ipAddress: "192.168.1.100",
    details: "Bill payment $145.00 to State Farm Insurance",
  },
  {
    id: "audit-005",
    timestamp: isoDate(3),
    user: "demo@example.com",
    action: "rdc.submit" as const,
    entityType: "rdc",
    entityId: "rdc-002",
    ipAddress: "192.168.1.100",
    details: "Check deposit $750.00",
  },
];
...
const ADMIN_INTEGRATIONS = [
  {
    id: "int-001",
    domain: "core_banking" as const,
    domainLabel: "Core Banking",
    provider: "Mock Adapter",
    isConnected: true,
    health: "healthy" as const,
    lastSyncAt: isoDate(0),
    webhookUrl: null,
    apiKeyMasked: "****abcd",
  },
  {
  ...
  {
    id: "int-003",
    domain: "bill_pay" as const,
    domainLabel: "Bill Pay",
    provider: "Mock Adapter",
    isConnected: true,
    health: "healthy" as const,
    lastSyncAt: isoDate(1),
    webhookUrl: null,
    apiKeyMasked: "****ijkl",
  },
  {
  ...
  },
  {
    id: "int-005",
    domain: "kyc" as const,
    domainLabel: "KYC Verification",
    provider: "Alloy",
    isConnected: true,
    health: "degraded" as const,
    lastSyncAt: isoDate(2),
    webhookUrl: null,
    apiKeyMasked: "****qrst",
  },
];
