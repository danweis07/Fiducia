...
const incidentPaymentGateway = {
  ...
  description:
    "Prometheus alert fired: payment_gateway_latency_p99 exceeded 2000ms threshold for 5 consecutive minutes. Traced to v2.4.0 deployment introducing unindexed query in ACH batch processor.",
  ...
  resolutionSummary:
    "Rolled back from v2.4.0 to v2.3.1. ACH batch query lacked index on settlement_date. Hotfix prepared in CR-005.",
  ...
  timeline: [
    {
      timestamp: isoDate(0.17),
      action: "detected",
      actor: "AlertManager",
      detail: "Alert HighLatencyPaymentGateway fired — P99 latency 2340ms",
    },
    {
      timestamp: isoDate(0.168),
      action: "investigating",
      actor: "ops-lead@fiducia.dev",
      detail: "Investigating — correlating with recent v2.4.0 deployment",
    },
    {
      timestamp: isoDate(0.165),
      action: "root_cause",
      actor: "ops-lead@fiducia.dev",
      detail: "Root cause identified: unindexed query in ACH batch processor introduced in v2.4.0",
    },
    {
      timestamp: isoDate(0.16),
      action: "rollback_initiated",
      actor: "ops-lead@fiducia.dev",
      detail: "Initiating rollback from v2.4.0 to v2.3.1",
    },
    {
      timestamp: isoDate(0.155),
      action: "rollback_completed",
      actor: "system",
      detail: "Rollback to v2.3.1 completed successfully. All health checks passing.",
    },
    {
      timestamp: isoDate(0.154),
      action: "stakeholders_notified",
      actor: "system",
      detail: "Notified ops-team, CTO, compliance via Slack and email",
    },
    {
      timestamp: isoDate(0.14),
      action: "resolved",
      actor: "ops-lead@fiducia.dev",
      detail: "Incident resolved. P99 latency returned to 180ms. Hotfix CR-005 created.",
    },
  ],
  ...
  timeline: [
    {
      ...
      action: "detected",
      actor: "HealthCheck",
      detail: "TLS cert expires in 7 days for api.demo-bank.com",
    },
    {
      timestamp: isoDate(0.4),
      action: "investigating",
      actor: "infra@fiducia.dev",
      detail: "Checking auto-renewal configuration in Cloudflare",
    },
  ],
...
const changeRequests = [
  {
    ...
    testResults: {
      unit: { passed: 247, failed: 0, total: 247 },
      e2e: { passed: 38, failed: 1, total: 39 },
      coveragePct: 34.2,
    },
  ...
  },
  {
    ...
    testStatus: "passed" as const,
    testResults: {
      unit: { passed: 312, failed: 0, total: 312 },
      e2e: { passed: 42, failed: 0, total: 42 },
      coveragePct: 36.1,
    },
  ...
  },
  {
    ...
    description:
      "Add missing index on settlement_date column in ach_batches table. Root cause of INC-001.",
...
const deployments = [
  ...
  },
  {
    id: "dep-003",
    version: "v2.3.1",
    deploymentType: "functions" as const,
    status: "success" as const,
    triggeredBy: "ci",
    gitSha: "u7v8w9x",
    durationMs: 18300,
  ...
  },
  {
    id: "dep-005",
    version: "v2.2.9",
    deploymentType: "migrations" as const,
    status: "success" as const,
    triggeredBy: "manual",
    gitSha: "y0z1a2b",
    durationMs: 8400,
      ...
      timeline: [
        {
          ...
          action: "detected",
          actor: "manual",
          detail: "Incident created manually",
        },
      ],
    },
  }),
