...
export const integrationHandlers: Record<string, ActionHandler> = {
    ...
    locations: [
      {
        ...
        services: ["ATM", "Drive-through", "Safe deposit", "Notary"],
        isOpen: true,
      ...
      {
        id: "loc-002",
        name: "Demo CU ATM - Grocery Store",
        type: "atm",
        latitude: 39.79,
        longitude: -89.64,
        address: "500 S Grand Ave",
        city: "Springfield",
        state: "IL",
        zip: "62703",
        phone: null,
  ...
  "accountProducts.list": () => ({
    products: [
      {
        id: "prod-checking-001",
        name: "Free Checking",
        shortName: "Free Chk",
        description: "No monthly fee checking account",
        type: "checking",
        interestRateBps: 25,
        interestCompounding: "monthly",
        interestPosting: "monthly",
        interestCalculation: "daily_balance",
        minimumOpeningBalanceCents: 2500,
        minimumBalanceCents: 0,
        maximumBalanceCents: null,
        withdrawalLimitPerMonth: null,
        termMonths: null,
        earlyWithdrawalPenaltyBps: null,
        autoRenew: false,
        isActive: true,
      },
      {
        ...
        interestPosting: "monthly",
        interestCalculation: "daily_balance",
        minimumOpeningBalanceCents: 10000,
        minimumBalanceCents: 0,
        maximumBalanceCents: null,
      ...
      },
      {
        ...
        name: "12-Month CD",
        shortName: "12M CD",
        description: "5.00% APY for 12 months",
        type: "cd",
        interestRateBps: 500,
        interestCompounding: "monthly",
        interestPosting: "monthly",
        interestCalculation: "daily_balance",
        minimumOpeningBalanceCents: 100000,
        minimumBalanceCents: 100000,
        maximumBalanceCents: null,
    ...
    chargeDefinitions: [
      {
        ...
        chargeType: "monthly_maintenance",
        appliesTo: "checking",
        amountCents: 1000,
        isPercentage: false,
        frequency: "monthly",
        waivable: true,
        waiveIfBalanceAboveCents: 150000,
        maxPerDay: null,
        isActive: true,
      },
      {
        id: "chdef-002",
        name: "Overdraft Fee",
        description: "Fee for insufficient funds",
        ...
        charges: [
          {
            ...
            loanId: null,
            chargeDefinitionId: "chdef-001",
            amountCents: 1000,
            status: "waived",
            waivedReason: "Balance above $1,500",
            waivedAt: isoDate(5),
            appliedAt: null,
            createdAt: isoDate(5),
          },
    ...
    instructions: [
      {
        ...
        toLoanId: null,
        transferType: "account_to_account" as const,
        amountCents: 50000,
