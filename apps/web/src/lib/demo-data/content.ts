...
export const contentHandlers: Record<string, ActionHandler> = {
  ...
  "passwordPolicy.get": () => ({
    policy: {
      ...
      username: {
        ...
        allowEmail: true,
        pattern: "^[a-zA-Z0-9@._-]+$",
        patternDescription: "Letters, numbers, @, ., _, -",
      },
      password: {
        minLength: 8,
        maxLength: 128,
    ...
    channels: [
      {
        ...
        slug: "web_portal",
        label: "Web Portal",
        description: "Main customer web application",
        isActive: true,
        config: {},
      ...
      },
      {
        ...
        isActive: true,
        config: { topic: "org.example.banking" },
        createdAt: isoDate(180),
      },
      {
        id: "ch-005",
      ...
      },
      {
        ...
        slug: "atm_screen",
        label: "ATM Screen",
        description: "ATM screen banners and messages",
        isActive: true,
        config: {},
        createdAt: isoDate(180),
      },
  ...
  "cms.channels.update": (p) => ({
    channel: {
      id: p.id,
      slug: p.slug || "web_portal",
      label: p.label || "Web Portal",
  ...
  "cms.content.list": (p) => {
    const allContent = [
      ...
      {
        id: "cms-002",
        slug: "cd-rate-promotion",
        title: "5.00% APY on 12-Month CDs",
        body: "Lock in a great rate! Open a 12-Month Certificate of Deposit today and earn **5.00% APY**. Minimum deposit of $1,000.\n\n*Limited time offer. Rates subject to change. Early withdrawal penalties apply.*",
        contentType: "promotion" as const,
        status: "published" as const,
        channels: ["web_portal", "mobile_app", "email", "atm_screen"],
        metadata: {
          priority: "medium",
          badgeColor: "#10B981",
          ctaUrl: "/accounts",
      ...
      },
      {
        ...
        body: "Please note our modified hours for the upcoming holiday season:\n\n- **Dec 24**: 9AM - 12PM\n- **Dec 25**: Closed\n- **Dec 31**: 9AM - 3PM\n- **Jan 1**: Closed\n\nOnline and mobile banking remain available 24/7.",
        contentType: "announcement" as const,
        status: "draft" as const,
        channels: ["web_portal", "email", "sms"],
      ...
      },
      {
        ...
        status: "published" as const,
        channels: ["web_portal", "mobile_app"],
        metadata: { lastReviewedAt: isoDate(30) },
        locale: "en",
        authorId: "u-001",
      ...
      },
      {
        ...
        body: "Online banking will be unavailable Saturday 2AM-6AM for scheduled maintenance.",
    ...
    versions: [
      {
        ...
        status: "published",
        changedBy: "u-001",
        changeNote: "Updated feature list",
        createdAt: isoDate(7),
      },
      {
        id: "ver-001",
    ...
    tokens: [
      {
        ...
        tokenPrefix: "cms_wp01",
        scopes: ["read"],
        allowedChannels: ["web_portal"],
        rateLimit: 500,
        lastUsedAt: isoDate(0),
      ...
      {
        id: "tok-003",
        name: "Old Contentful Token",
        tokenPrefix: "cms_cf03",
        scopes: ["read"],
        allowedChannels: ["web_portal"],
        rateLimit: 500,
        lastUsedAt: isoDate(45),
  ...
  "cms.tokens.create": (p) => ({
    token: {
      id: `tok-demo-${Date.now()}`,
      name: p.name,
      tokenPrefix: `cms_${String(Date.now()).slice(-4)}`,
      scopes: p.scopes || ["read"],
      allowedChannels: p.allowedChannels || null,
      rateLimit: p.rateLimit || 1000,
      lastUsedAt: null,
      expiresAt: p.expiresAt || null,
      isRevoked: false,
      createdAt: new Date().toISOString(),
      rawToken: `cms_${String(Date.now()).slice(-4)}_sk_live_${Array.from({ length: 32 }, () => "abcdefghijklmnopqrstuvwxyz0123456789"[Math.floor(Math.random() * 36)]).join("")}`,
    },
  }),
    ...
    const allExperiments = [
      {
        ...
        description:
          "Testing whether a personalized CD rate banner increases conversions vs the generic banner",
        status: "running",
        metric: "click_rate",
        trafficPercent: 100,
      ...
      },
      {
        ...
        description: "Comparing simplified vs detailed onboarding flow",
        status: "draft",
      ...
      },
      {
        ...
        description: "Green vs blue transfer button",
        status: "completed",
        metric: "click_rate",
        trafficPercent: 100,
  ...
  "experiments.get": (p) => ({
    ...
    variants: [
      ...
      },
      {
        id: "var-002",
        experimentId: p.id || "exp-001",
        name: "Variant A — Personalized Rate",
        contentId: "cms-002",
        weight: 50,
        isControl: false,
        createdAt: isoDate(21),
  ...
  "experiments.results": (p) => ({
    ...
    variants: [
      ...
      {
        variantId: "var-002",
        variantName: "Variant A — Personalized Rate",
        isControl: false,
        impressions: 1256,
        clicks: 142,
        dismissals: 245,
