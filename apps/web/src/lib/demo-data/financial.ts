...
export const financialHandlers: Record<string, ActionHandler> = {
  ...
  "financial.spending": () => ({
    ...
    periodStart: isoDate(30).split("T")[0],
    ...
    byCategory: [
      {
        ...
        topMerchants: [{ name: "Rent Payment", totalCents: 150000 }],
      },
      {
        ...
        topMerchants: [
          ...
          { name: "Chipotle", totalCents: 9800, logoUrl: "https://logo.clearbit.com/chipotle.com" },
        ],
      },
      {
        category: "groceries",
        ...
        topMerchants: [
          ...
          },
          {
            name: "Trader Joe's",
            totalCents: 20300,
            logoUrl: "https://logo.clearbit.com/traderjoes.com",
          },
        ],
      },
      {
        ...
        topMerchants: [
          { name: "Chevron", totalCents: 18500, logoUrl: "https://logo.clearbit.com/chevron.com" },
          { name: "Uber", totalCents: 12300, logoUrl: "https://logo.clearbit.com/uber.com" },
        ],
      },
      {
        ...
        changeFromPreviousCents: 0,
        topMerchants: [
          { name: "Netflix", totalCents: 1599, logoUrl: "https://logo.clearbit.com/netflix.com" },
          { name: "Spotify", totalCents: 1099, logoUrl: "https://logo.clearbit.com/spotify.com" },
        ],
      },
      {
        category: "shopping",
        ...
        percentOfTotal: 9.9,
        trend: "up",
        changeFromPreviousCents: 12400,
        topMerchants: [
          { name: "Amazon", totalCents: 28700, logoUrl: "https://logo.clearbit.com/amazon.com" },
        ],
      },
      {
        category: "utilities",
        ...
        percentOfTotal: 6.6,
        trend: "stable",
        changeFromPreviousCents: 1200,
        topMerchants: [
          { name: "PG&E", totalCents: 14500 },
          { name: "AT&T", totalCents: 8599 },
        ],
      },
    ],
  }),
  ...
  "financial.networth.history": () => [
    ...
    {
      date: "2026-02-01",
      totalAssetsCents: 18124300,
      totalLiabilitiesCents: 3345800,
      netWorthCents: 14778500,
      accounts: [],
    },
    {
      date: "2026-01-01",
      totalAssetsCents: 17824300,
      totalLiabilitiesCents: 3445800,
      netWorthCents: 14378500,
      accounts: [],
    },
    {
      date: "2025-12-01",
      totalAssetsCents: 17524300,
      totalLiabilitiesCents: 3545800,
      netWorthCents: 13978500,
      accounts: [],
    },
    {
      date: "2025-11-01",
      totalAssetsCents: 17124300,
      totalLiabilitiesCents: 3645800,
      netWorthCents: 13478500,
      accounts: [],
    },
    {
      date: "2025-10-01",
      totalAssetsCents: 16824300,
      totalLiabilitiesCents: 3745800,
      netWorthCents: 13078500,
      accounts: [],
    },
  ],
  "financial.recurring": () => ({
    recurring: [
      {
        ...
        frequency: "monthly",
        nextExpectedDate: futureDate(18),
        isActive: true,
        lastChargeDate: isoDate(12),
        chargeCount: 24,
      },
      {
        recurringId: "rec-002",
        merchantName: "Spotify",
        merchantLogoUrl: "https://logo.clearbit.com/spotify.com",
        category: "subscriptions",
        averageAmountCents: 1099,
        lastAmountCents: 1099,
        frequency: "monthly",
        nextExpectedDate: futureDate(22),
        isActive: true,
        lastChargeDate: isoDate(8),
        chargeCount: 36,
      },
      {
        recurringId: "rec-003",
        merchantName: "Planet Fitness",
        merchantLogoUrl: "https://logo.clearbit.com/planetfitness.com",
        category: "personal_care",
        averageAmountCents: 2499,
        lastAmountCents: 2499,
        frequency: "monthly",
        nextExpectedDate: futureDate(3),
        isActive: true,
        lastChargeDate: isoDate(27),
        chargeCount: 18,
      },
      {
        recurringId: "rec-004",
        merchantName: "AT&T Wireless",
        merchantLogoUrl: "https://logo.clearbit.com/att.com",
        category: "utilities",
        averageAmountCents: 8599,
        lastAmountCents: 8599,
        frequency: "monthly",
        nextExpectedDate: futureDate(12),
        isActive: true,
        lastChargeDate: isoDate(18),
        chargeCount: 48,
      },
      {
        recurringId: "rec-005",
        merchantName: "Adobe Creative Cloud",
        merchantLogoUrl: "https://logo.clearbit.com/adobe.com",
        category: "subscriptions",
        averageAmountCents: 5499,
        lastAmountCents: 5499,
        frequency: "monthly",
        nextExpectedDate: futureDate(8),
        isActive: true,
        lastChargeDate: isoDate(22),
        chargeCount: 12,
      },
      {
        recurringId: "rec-006",
        ...
        category: "subscriptions",
        averageAmountCents: 14900,
        lastAmountCents: 14900,
        frequency: "annual",
        nextExpectedDate: futureDate(120),
        isActive: true,
        lastChargeDate: isoDate(245),
        chargeCount: 5,
      },
    ],
    ...
    offers: [
      {
        ...
        description:
          "Earn 5% cash back on all purchases at Starbucks locations. Minimum spend $10.",
      ...
      },
      {
        ...
        description: "Get 3% back on Amazon.com purchases.",
        offerType: "cashback_percent",
        rewardValue: 300,
      ...
      },
      {
        ...
        description: "Save 15% on your next 3 Uber rides. Max discount $5 per ride.",
      ...
      },
      {
        ...
        merchant: {
          merchantId: "mch_wholefoods",
          name: "Whole Foods Market",
          logoUrl: "https://logo.clearbit.com/wholefoodsmarket.com",
          category: "groceries",
        },
        headline: "8% cash back at Whole Foods",
        description: "Earn 8% back on all Whole Foods purchases.",
        offerType: "cashback_percent",
        rewardValue: 800,
