...
export type Database = {
  ...
  public: {
    Tables: {
      ...
      outreach_threads: {
        Row: {
          ...
          thread_sentiment: Database["public"]["Enums"]["reply_sentiment"] | null;
          updated_at: string | null;
        };
        Insert: {
          contact_email: string;
    ...
    Views: {
      ...
      draft_approval_queue: {
        Row: {
          ...
          thread_id: string | null;
          transition_score: number | null;
          trigger_type: Database["public"]["Enums"]["outreach_trigger_type"] | null;
        };
        Relationships: [
          {
            foreignKeyName: "outreach_drafts_firm_id_fkey";
    ...
    Enums: {
      ...
      draft_action: "approved" | "approved_with_edits" | "revision_requested" | "rejected";
      ...
      integration_category:
        ...
        | "calendar"
        | "accounting";
      integration_status: "connected" | "disconnected" | "expired" | "error" | "pending";
      outreach_status:
        | "drafting"
        | "pending_approval"
        | "approved"
...
export const Constants = {
  public: {
    Enums: {
      ...
      draft_action: ["approved", "approved_with_edits", "revision_requested", "rejected"],
      integration_auth_type: ["oauth2", "api_key", "webhook_only", "none"],
      integration_category: ["documents", "crm", "communication", "data", "calendar", "accounting"],
      integration_status: ["connected", "disconnected", "expired", "error", "pending"],
      outreach_status: [
        "drafting",
        "pending_approval",
