        ...
        <div className="space-y-4">
          ...
          <div className="grid gap-4">
            {activeLoans.map((loan) => {
              const loanType =
                loan.status === "active"
                  ? (loan as unknown as { _loanType?: LoanType })?._loanType
                  : undefined;
                    ...
                    <div className="flex items-end justify-between">
                      <div className="space-y-2">
                        <div>
                          ...
                          <p className="text-xs text-muted-foreground">
                            {t("accounts.ofOriginal", {
                              amount: formatCurrency(loan.principalCents),
                            })}
                            <span className="ml-3">
                        ...
                        <div className="flex items-center gap-2">
                          ...
                          <span className="text-xs text-muted-foreground">
                            {t("accounts.paidPercent", { percent: progressPct })}
                          </span>
                        </div>
                        {loan.nextPaymentDueDate && loan.nextPaymentAmountCents && (
                          <p className="text-xs text-muted-foreground">
                            {t("accounts.nextPayment", {
                              amount: formatCurrency(loan.nextPaymentAmountCents),
                              date: new Date(loan.nextPaymentDueDate).toLocaleDateString(
                                undefined,
