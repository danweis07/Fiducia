...
import { Zap, Plus, Pause, Play, Trash2, Sparkles } from "lucide-react";
...
export default function AutomationRules() {
  ...
  const createRule = useMutation({
    ...
    onSuccess: () => {
      ...
      setRuleText("");
      toast({
        title: t("automationRules.ruleCreated"),
        description: t("automationRules.ruleCreatedDesc"),
      });
    },
    onError: () => {
        ...
        <div className="p-4 md:p-6 space-y-6">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-muted-foreground">{t("automationRules.subtitle")}</p>
            </div>
