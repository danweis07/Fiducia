    ...
    ? [
        {
          ...
          value: formatCurrency(aggregates.totalCheckingCents),
          color: "text-blue-700 bg-blue-50",
        },
        {
          label: "Total Savings",
          value: formatCurrency(aggregates.totalSavingsCents),
          color: "text-green-700 bg-green-50",
        },
        {
          label: "Total CDs",
          value: formatCurrency(aggregates.totalCDCents),
          color: "text-purple-700 bg-purple-50",
        },
        {
          label: "Money Market",
          value: formatCurrency(aggregates.totalMoneyMarketCents),
      ...
      <Card>
        <CardHeader className="pb-3">
          <CardTitle className="text-base">
            {t("accountOverview.allAccounts", {
              count: (aggregates?.totalAccounts ?? 0).toLocaleString(),
            })}
          </CardTitle>
        </CardHeader>
        <CardContent className="space-y-4">
          <div className="flex flex-col sm:flex-row gap-3">
            <div className="relative flex-1">
              ...
              <Input
                placeholder={t("accountOverview.searchPlaceholder")}
                value={search}
            ...
            <Select value={typeFilter} onValueChange={setTypeFilter}>
              ...
              <SelectContent>
                ...
                <SelectItem value="money_market">
                  {t("accountOverview.filters.moneyMarket")}
                </SelectItem>
              </SelectContent>
            </Select>
                ...
                {filtered.length === 0 && (
                  <TableRow>
                    <TableCell colSpan={7} className="text-center py-8 text-slate-400">
                      {t("accountOverview.noAccountsFound")}
                    </TableCell>
                  </TableRow>
                )}
              </TableBody>
