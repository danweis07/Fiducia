  ...
  [
    {
      value: "modern",
      label: "Modern",
      description: "Clean lines, rounded cards, generous spacing",
    },
    {
      value: "classic",
      label: "Classic",
      description: "Traditional banking look with sharp edges",
    },
...
export default function BrandingEditor() {
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      toast({
        title: t("brandingEditor.toast.saveFailed"),
        description: t("brandingEditor.toast.saveFailedDescription"),
        variant: "destructive",
      });
    } finally {
      setSaving(false);
              ...
              >
                ...
                >
                  ...
                  <span className="text-white text-sm font-semibold">
                    {t("brandingEditor.previewDemo.institutionName")}
                  </span>
                </div>
                ...
                <div className="p-4 space-y-4">
                  ...
                  <div className={`rounded-lg p-4 ${darkPreview ? "bg-slate-800" : "bg-slate-50"}`}>
                    <p className="text-xs opacity-60">
                      {t("brandingEditor.previewDemo.totalBalance")}
                    </p>
                    <p className="text-2xl font-bold mt-1">$18,077.73</p>
                    <p className="text-xs opacity-50 mt-0.5">
                      {t("brandingEditor.previewDemo.acrossAccounts")}
                    </p>
                  </div>
                  ...
                  {["Whole Foods", "Netflix", "Payroll"].map((name) => (
                    <div key={name} className="flex items-center justify-between">
                      <div className="flex items-center gap-2">
                        <div
                          className={`h-8 w-8 rounded-full ${darkPreview ? "bg-slate-700" : "bg-slate-200"}`}
                        />
                        <div>
