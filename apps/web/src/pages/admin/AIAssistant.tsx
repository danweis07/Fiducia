...
import { Bot, Save, AlertTriangle, MessageCircle, Settings2, Eye } from "lucide-react";
...
export default function AIAssistant() {
  ...
  const updatePrompt = useMutation({
    mutationFn: (params: { promptId: string; content: string }) => gateway.ai.updatePrompt(params),
    onSuccess: () => {
      queryClient.invalidateQueries({ queryKey: ["ai", "prompts"] });
      setEditingPrompt(null);
      toast({
        title: t("aiAssistant.toasts.promptUpdated"),
        description: t("aiAssistant.toasts.promptUpdatedDesc"),
      });
    },
    onError: () => {
  ...
  const testChat = useMutation({
    mutationFn: (message: string) => gateway.ai.chat({ message }),
    onSuccess: (data) => {
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-2">
                      <Badge variant={prompt.isActive ? "default" : "outline"}>
                        {prompt.isActive
                          ? t("aiAssistant.prompts.active")
                          : t("aiAssistant.prompts.inactive")}
                      </Badge>
                      <Button
                        variant="outline"
                        size="sm"
                ...
                {editingPrompt === prompt.id ? (
                    ...
                    <div className="flex gap-2">
                      ...
                      >
                        ...
                        {updatePrompt.isPending
                          ? t("aiAssistant.prompts.saving")
                          : t("aiAssistant.prompts.savePrompt")}
                      </Button>
                  ...
                  <CardContent>
                    ...
                    <p className="text-xs text-muted-foreground mt-2">
                      {t("aiAssistant.prompts.lastUpdated", {
        ...
        <TabsContent value="test" className="space-y-4 mt-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>{t("aiAssistant.testConsole.description")}</CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              <div className="space-y-2">
        ...
        <TabsContent value="escalations" className="space-y-4 mt-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>{t("aiAssistant.escalations.queueDescription")}</CardDescription>
            </CardHeader>
            <CardContent>
              <EmptyState
                icon={AlertTriangle}
          ...
          <Card>
            <CardHeader>
              <CardTitle className="text-base">
                {t("aiAssistant.escalations.settingsTitle")}
              </CardTitle>
            </CardHeader>
            <CardContent className="space-y-4">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-sm font-medium">
                    {t("aiAssistant.escalations.autoEscalateSupport")}
                  </p>
              ...
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-sm font-medium">
                    {t("aiAssistant.escalations.autoEscalateProduct")}
                  </p>
                  <p className="text-xs text-muted-foreground">
              ...
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-sm font-medium">
                    {t("aiAssistant.escalations.notificationOnEscalation")}
                  </p>
                  <p className="text-xs text-muted-foreground">
