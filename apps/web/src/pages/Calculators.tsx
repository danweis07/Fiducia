...
function SavingsGrowthTab() {
  ...
  const result = useMemo(() => {
    ...
    const futureValueCents = compoundInterestWithContributions(
      principalCents,
      monthlyCents,
      rateBps,
      yrs,
    ...
    <div className="grid md:grid-cols-2 gap-6">
      <Card>
        <CardHeader>
          ...
          <CardDescription>{t("calculators.savingsGrowthDesc")}</CardDescription>
        </CardHeader>
            ...
            <div className="space-y-4">
              <div>
                ...
                <p className="text-3xl font-bold text-primary">
                  {formatCurrency(result.futureValueCents)}
                </p>
              </div>
              <div className="grid grid-cols-2 gap-4">
                <div>
                  <p className="text-sm text-muted-foreground">
                    {t("calculators.totalContributions")}
                  </p>
                  <p className="text-xl font-semibold">
                    {formatCurrency(result.totalContributionsCents)}
                  </p>
                </div>
                <div>
              ...
              <div>
                ...
                <p className="text-base">
                  {formatInterestRate(percentToBps(annualRate))} {t("calculators.annually")}
                </p>
              </div>
            </div>
          ) : (
    ...
    <div className="grid md:grid-cols-2 gap-6">
      <Card>
        <CardHeader>
          ...
          <CardDescription>{t("calculators.loanPaymentDesc")}</CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
          <div className="space-y-2">
          ...
          {result ? (
            <div className="space-y-4">
              <div>
                ...
                <p className="text-3xl font-bold text-primary">
                  {formatCurrency(result.monthlyPaymentCents)}
                </p>
              </div>
              <div className="grid grid-cols-2 gap-4">
                <div>
                ...
                <div>
                  ...
                  <p className="text-xl font-semibold text-orange-600">
                    {formatCurrency(result.totalInterestCents)}
                  </p>
                </div>
              </div>
              <div>
    ...
    <div className="grid md:grid-cols-2 gap-6">
      <Card>
        <CardHeader>
          ...
          <CardDescription>{t("calculators.cdMaturityDesc")}</CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
          <div className="space-y-2">
          ...
          {result ? (
            <div className="space-y-4">
              <div>
                ...
                <p className="text-3xl font-bold text-primary">
                  {formatCurrency(result.maturityValueCents)}
                </p>
              </div>
              <div>
                <p className="text-sm text-muted-foreground">{t("calculators.interestEarned")}</p>
              ...
              <div>
                <p className="text-sm text-muted-foreground">{t("calculators.rate")}</p>
                <p className="text-base">
                  {formatInterestRate(percentToBps(annualRate))} {t("calculators.apy")}
                </p>
              </div>
            </div>
          ) : (
    ...
    <div className="grid md:grid-cols-2 gap-6">
      <Card>
        <CardHeader>
          ...
          <CardDescription>{t("calculators.debtPayoffDesc")}</CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
          <div className="space-y-2">
          ...
          {result ? (
            isInfinite ? (
              ...
              <div className="space-y-4">
                ...
                <div>
                  <p className="text-sm text-muted-foreground">
                    {t("calculators.totalInterestPaid")}
                  </p>
                  <p className="text-xl font-semibold text-orange-600">
                    {formatCurrency(result.totalInterestCents)}
                  </p>
    ...
    <div className="grid md:grid-cols-2 gap-6">
      <Card>
        <CardHeader>
          ...
          <CardDescription>{t("calculators.savingsGoalDesc")}</CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
          <div className="space-y-2">
        ...
        <CardContent>
          {result ? (
            <div className="space-y-4">
              <div>
                <p className="text-sm text-muted-foreground">
                  {t("calculators.monthlySavingsNeeded")}
                </p>
                <p className="text-3xl font-bold text-primary">
                  {formatCurrency(result.monthlyNeededCents)}
                </p>
              </div>
              <div className="grid grid-cols-2 gap-4">
                <div>
