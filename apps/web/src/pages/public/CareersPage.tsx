...
const benefits = [
  ...
  },
  {
    ...
    description:
      "Up to $5,250 per year toward continuing education and professional certifications.",
  },
  {
    icon: Users,
    ...
    <PublicShell>
      ...
      <section className="bg-blue-900 text-white py-20 px-4">
        <div className="max-w-4xl mx-auto text-center">
          <h1 className="text-4xl md:text-5xl font-bold mb-4">Build Your Career With Us</h1>
          <p className="text-xl text-blue-100 max-w-2xl mx-auto">
            Join a team of 850+ professionals who are passionate about helping members achieve their
            financial goals and strengthening the communities we serve.
          </p>
        </div>
      </section>
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-10">
            ...
            <div>
              ...
              <h3 className="text-lg font-semibold text-slate-900 mb-2">Member-First Culture</h3>
              <p className="text-slate-600">
                Every role connects to our mission of empowering members. You will see the direct
                impact of your work every day.
              </p>
            </div>
            <div>
              <div className="w-14 h-14 bg-blue-100 rounded-full mx-auto mb-4 flex items-center justify-center">
      ...
      <section className="bg-slate-50 py-16 px-4">
        <div className="max-w-5xl mx-auto">
          <h2 className="text-3xl font-bold text-slate-900 mb-10 text-center">Benefits & Perks</h2>
      ...
      <section className="bg-white py-16 px-4">
        <div className="max-w-3xl mx-auto text-center">
          <h2 className="text-3xl font-bold text-slate-900 mb-4">Don&apos;t See the Right Fit?</h2>
          <p className="text-slate-600 text-lg mb-2">
            We are always interested in hearing from talented people. Send us your resume and we
