          ...
          <div className="text-center mb-12">
            ...
            <div className="inline-flex items-center gap-3 bg-blue-50 rounded-full px-6 py-3">
              ...
              <span className="text-lg font-semibold text-blue-700">
                $2.5M+ in annual charitable giving since 1952
              </span>
            </div>
      ...
      <section className="py-16 px-4 bg-slate-50">
        <div className="max-w-5xl mx-auto text-center">
          ...
          <p className="text-slate-600 max-w-2xl mx-auto mb-10">
            Community involvement isn&apos;t just a corporate initiative — it&apos;s part of who we
            are. Our employees are passionate about giving back.
          </p>
      ...
      <section className="py-16 px-4 bg-slate-50">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-slate-600 max-w-2xl mx-auto">
              We&apos;re committed to reducing our environmental footprint and promoting sustainable
