    ...
    <PublicShell tenantName="Demo Credit Union">
          ...
          <div className="grid md:grid-cols-3 gap-8">
              ...
              <CardContent>
                <ul className="space-y-2 text-sm text-slate-700 mb-6">
                  <li className="flex items-center gap-2">
                    <ArrowRight className="h-4 w-4 text-blue-500" /> $5 minimum to open
                  </li>
                  <li className="flex items-center gap-2">
                    <ArrowRight className="h-4 w-4 text-blue-500" /> No monthly fees
                  </li>
                  <li className="flex items-center gap-2">
                    <ArrowRight className="h-4 w-4 text-blue-500" /> Dividends paid monthly
                  </li>
                </ul>
            ...
            <Card className="border-2 border-blue-500 shadow-lg relative">
              ...
              <CardContent>
                <ul className="space-y-2 text-sm text-slate-700 mb-6">
                  <li className="flex items-center gap-2">
                    <ArrowRight className="h-4 w-4 text-blue-500" /> $500 minimum to open
                  </li>
                  <li className="flex items-center gap-2">
                    <ArrowRight className="h-4 w-4 text-blue-500" /> No monthly fees
                  </li>
                  <li className="flex items-center gap-2">
                    <ArrowRight className="h-4 w-4 text-blue-500" /> Dividends compounded daily
                  </li>
                  <li className="flex items-center gap-2">
                    <ArrowRight className="h-4 w-4 text-blue-500" /> Unlimited deposits
                  </li>
                </ul>
                <Button asChild className="w-full bg-blue-600 hover:bg-blue-700">
                  <Link to="/open-account">{t("savings.openAccount")}</Link>
            ...
            <Card className="border-2 border-slate-200 hover:border-blue-300 transition-colors">
              ...
              <CardContent>
                <ul className="space-y-2 text-sm text-slate-700 mb-6">
                  <li className="flex items-center gap-2">
                    <ArrowRight className="h-4 w-4 text-blue-500" /> $2,500 minimum to open
                  </li>
                  <li className="flex items-center gap-2">
                    <ArrowRight className="h-4 w-4 text-blue-500" /> Check-writing privileges
                  </li>
                  <li className="flex items-center gap-2">
                    <ArrowRight className="h-4 w-4 text-blue-500" /> Tiered dividend rates
                  </li>
                  <li className="flex items-center gap-2">
                    <ArrowRight className="h-4 w-4 text-blue-500" /> ATM/debit card access
                  </li>
                </ul>
                <Button asChild className="w-full bg-blue-600 hover:bg-blue-700">
                  <Link to="/open-account">{t("savings.openAccount")}</Link>
              ...
              >
                ...
                <CardContent>
                  ...
                  <p className="text-sm text-slate-600 mb-4">
                    {t("savings.minimumDeposit", { amount: cd.min })}
                  </p>
                  <Button asChild className="w-full bg-blue-600 hover:bg-blue-700">
      ...
      <section className="py-16 px-4 bg-blue-600 text-white">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <p className="text-blue-100 mb-8 text-lg">{t("savings.ctaDescription")}</p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Button
              asChild
              size="lg"
