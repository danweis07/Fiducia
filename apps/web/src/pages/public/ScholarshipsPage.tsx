...
const timeline = [
  {
    ...
    description: "Online application portal opens for the current academic year.",
  },
  {
    icon: ClipboardList,
    date: "March 31",
    label: "Application Deadline",
    description: "All materials including essay and transcripts must be submitted.",
  },
  {
    icon: Users,
    date: "May 15",
    label: "Recipients Announced",
    description: "Scholarship committee notifies selected recipients by email and phone.",
  },
  {
    icon: DollarSign,
    date: "August 1",
    label: "Awards Disbursed",
    description: "Funds sent directly to the recipient's educational institution.",
  },
];
...
const howToApply = [
  ...
  },
  {
    ...
    description:
      "Fill out the online application form with your personal information, academic history, extracurricular activities, and community involvement.",
  },
  {
    step: "3",
    title: "Submit Essay",
    description:
      "Write a 500-word essay on how financial literacy has impacted your life and how you plan to contribute to your community after graduation.",
  },
  {
    step: "4",
    title: "Provide Transcripts",
    description:
      "Upload or mail official or unofficial transcripts showing your cumulative GPA. Transcripts must be from the most recent completed semester.",
  },
];
