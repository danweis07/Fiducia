...
import { Smartphone, AlertCircle, ArrowRight, ArrowLeft } from "lucide-react";
  ...
  return (
    <Card className="max-w-2xl mx-auto">
      <CardHeader>
        ...
        <CardDescription>
          Register this device as trusted so you won&apos;t need to verify it each time you sign in.
