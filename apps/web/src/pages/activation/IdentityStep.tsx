...
import { CheckCircle2, User, AlertCircle, ArrowRight } from "lucide-react";
import { useVerifyIdentity } from "@/hooks/useActivation";
import type { ActivationConfig, IdentityVerificationResult } from "@/types/activation";
    ...
    return (
      <Card className="max-w-2xl mx-auto">
        <CardHeader>
          ...
          <CardDescription>We found your account. Please confirm this is you.</CardDescription>
        </CardHeader>
        ...
        {config.identity.requiredFields.map((field) => (
          <div key={field} className="space-y-2">
            ...
            <Input
              ...
              placeholder={
                field === "ssn" ? "Last 4 digits" : field === "zipCode" ? "5-digit ZIP" : undefined
              }
