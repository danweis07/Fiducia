...
export function StepMFA({
    ...
    enrollMFA.mutate(
      {
        ...
        destination:
          selectedMethod === "sms" || selectedMethod === "email" ? destination : undefined,
      },
      {
        onSuccess: (result) => {
    ...
    return (
      <Card className="max-w-2xl mx-auto">
        <CardHeader>
          ...
          <CardDescription>
            These codes can be used to access your account if you lose access to your MFA device.
            Save them somewhere safe — they will only be shown once.
          </CardDescription>
        </CardHeader>
  ...
  if (
    enrollResult &&
    (selectedMethod === "sms" || selectedMethod === "email" || selectedMethod === "totp")
  ) {
    return (
      <Card className="max-w-2xl mx-auto">
        <CardHeader>
        ...
        {!selectedMethod ? (
          ...
          <div className="space-y-4">
            <div className="flex items-center gap-2 mb-2">
              <Badge variant="secondary">{MFA_METHOD_META[selectedMethod].label}</Badge>
            </div>
            ...
            {(selectedMethod === "sms" || selectedMethod === "email") && (
              <div className="space-y-2">
                ...
                <Input
                  ...
                  placeholder={selectedMethod === "sms" ? "(555) 123-4567" : "your@email.com"}
            ...
            {selectedMethod === "passkey" && (
              <div className="text-center py-4 space-y-3">
                ...
                <p className="text-sm text-muted-foreground">
                  Register a passkey using your device&apos;s built-in authenticator or a security
                  key.
                </p>
              </div>
            )}
            ...
            {selectedMethod === "biometric" && (
              <div className="text-center py-4 space-y-3">
                ...
                <p className="text-sm text-muted-foreground">
                  Enable biometric sign-in using your device&apos;s fingerprint or face recognition.
                </p>
              </div>
            )}
            ...
            {selectedMethod === "totp" && (
              <p className="text-sm text-muted-foreground">
                You&apos;ll be shown a QR code to scan with your authenticator app (e.g. Google
                Authenticator, Authy).
              </p>
            )}
          </div>
