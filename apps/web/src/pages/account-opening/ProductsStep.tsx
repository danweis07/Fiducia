  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>{t("accountOpening.selectProductsDesc")}</CardDescription>
      </CardHeader>
              ...
              >
                <CardHeader className="pb-2">
                  ...
                  <Badge variant="secondary" className="w-fit">
                    {PRODUCT_TYPE_BADGE_KEYS[product.type]
                      ? t(PRODUCT_TYPE_BADGE_KEYS[product.type])
                      : product.type}
                  </Badge>
                </CardHeader>
                <CardContent className="space-y-2 text-sm">
                  ...
                  <div className="flex flex-wrap gap-x-4 gap-y-1 text-xs">
                    ...
                    <span>
                      {t("accountOpening.minDeposit", {
                        amount: formatCurrency(product.minOpeningDepositCents),
                      })}
                    </span>
                    {product.monthlyFeeCents > 0 ? (
                      <span>
                        {t("accountOpening.monthlyFee", {
                          amount: formatCurrency(product.monthlyFeeCents),
                        })}
                      </span>
                    ) : (
