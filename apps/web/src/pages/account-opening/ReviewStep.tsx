  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>{t("accountOpening.reviewDesc")}</CardDescription>
      </CardHeader>
      <CardContent className="space-y-6">
        ...
        <div>
          ...
          <div className="grid gap-2 text-sm sm:grid-cols-2">
            ...
            <div>
              ...
              <span className="font-medium capitalize">{form.citizenship.replace(/_/g, " ")}</span>
            </div>
          </div>
        </div>
        ...
        <div className="rounded-md bg-muted/50 p-4 text-sm text-muted-foreground">
          <div className="flex items-start gap-2">
            ...
            <p>{t("accountOpening.kycDisclosure")}</p>
          </div>
        </div>
      </CardContent>
