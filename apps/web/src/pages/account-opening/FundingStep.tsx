  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>{t("accountOpening.fundYourAccountDesc")}</CardDescription>
      </CardHeader>
        ...
        {form.fundingMethod && form.fundingMethod !== "none" && (
          <div className="space-y-2">
            ...
            <Input
              ...
              onChange={(e) => updateField("fundingAmountDollars", e.target.value)}
              placeholder="100.00"
            />
            {errors.fundingAmountDollars && (
              <p className="text-xs text-destructive">{errors.fundingAmountDollars}</p>
            )}
          </div>
        )}
      </CardContent>
