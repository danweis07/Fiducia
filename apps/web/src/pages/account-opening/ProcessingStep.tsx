      ...
      <CardContent className="flex flex-col items-center space-y-4 py-8">
        {isProcessing && (
          <>
            ...
            <p className="text-muted-foreground">{t("accountOpening.verifyingMessage")}</p>
          </>
        )}
        {isApproved && (
          <>
            ...
            <p className="text-muted-foreground">{t("accountOpening.identityVerifiedMessage")}</p>
          </>
        )}
        {isDenied && (
          <>
            ...
            <p className="text-muted-foreground">{t("accountOpening.verificationDeniedMessage")}</p>
          </>
        )}
        {isReview && (
          <>
            ...
            <p className="text-muted-foreground">{t("accountOpening.additionalReviewMessage")}</p>
          </>
        )}
        {isError && (
          <>
            ...
            <p className="text-muted-foreground">{t("accountOpening.processingError")}</p>
          </>
        )}
      </CardContent>
