...
import { ArrowRight, ArrowLeft, FileText, Upload, CheckCircle2 } from "lucide-react";
  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>{t("loanApplication.supportingDocumentsDesc")}</CardDescription>
      </CardHeader>
      <CardContent className="space-y-4">
        ...
        <div className="border-2 border-dashed rounded-lg p-8 text-center">
          ...
          <p className="text-sm text-muted-foreground mb-2">{t("loanApplication.dragAndDrop")}</p>
